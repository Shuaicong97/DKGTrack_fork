...
#SBATCH --job-name=dkgtrack_ovis_test
...
--resume /home/atuin/v100dd/v100dd19/dkgtrack/outputs/ovis_a40/checkpoint0099.pth \
--output_dir /home/atuin/v100dd/v100dd19/dkgtrack/outputs/ovis_a40
